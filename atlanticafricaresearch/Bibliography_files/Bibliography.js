IMpreload('Bibliography_files', 'shapeimage_4', '0');
IMpreload('Bibliography_files', 'shapeimage_4', '1');
IMpreload('Bibliography_files', 'shapeimage_4', '2');
var MINIMUM_FONT = "10";
var UNITS = "";
...
function onPageLoad()
{
    ...
    fixupIEPNG("id1", "Bibliography_files/transparent.gif");
    fixupIEPNG("shapeimage_4_link_0", "Bibliography_files/transparent.gif");
    fixupIEPNG("shapeimage_4_link_1", "Bibliography_files/transparent.gif");
    fixupIEPNG("shapeimage_4_link_2", "Bibliography_files/transparent.gif");
    fixupIEPNG("shapeimage_4", "Bibliography_files/transparent.gif");
    return true;
}
